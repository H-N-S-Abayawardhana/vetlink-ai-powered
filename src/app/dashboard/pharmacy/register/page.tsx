    ...
    <div className="max-w-4xl mx-auto p-4 sm:p-6 space-y-6">
      ...
      <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
        ...
        <p className="text-sm sm:text-base text-gray-600">
          Join our network and manage your pharmacy inventory with AI-powered
          demand prediction.
        </p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
        ...
        {message && (
          <div
            className={`mx-4 sm:mx-6 mt-4 sm:mt-6 p-4 rounded-lg flex items-start gap-3 ${
              messageType === "success"
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-blue-100 text-sm leading-relaxed">
              ...
              track sales, and use AI-powered demand prediction to optimize your
              stock levels. Our team will review your registration and activate
